"""Test current Hades (with fixes) vs Lethe + v872 on the same 4 bisect maps."""
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=THREADS) as ex:
        ...
        for f in as_completed(futs):
            ...
            completed += 1
            entry = results[opp]
            hades = bot_a if bot_a == "bots/Hades" else bot_b
            if mr.error:
                entry[3] += 1
    ...
    print()
    print(f"=== Hades (with fixes) — {NUM_MAPS} maps × 2 sides ===")
