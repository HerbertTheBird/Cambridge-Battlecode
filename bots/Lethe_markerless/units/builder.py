...
def handle_comms():
    ...
    # plus add the predicted target of each non-explorer friend so my explorer
    # avoids the corridor toward what they're heading at.
    claimed_targets[explore.comm_flag] = friends
