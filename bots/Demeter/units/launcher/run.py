...
def run_launcher(player, ct: Controller, my_pos: Position, vc) -> None:
    ...
    for target_msg, builder_id_tag, marker_idx, marker_id, _created_round in tuple(player.comms.launch_orders):
        target = player.comms.decode_launch_order_target(target_msg)
