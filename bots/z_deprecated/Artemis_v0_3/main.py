            ...
            if not self.initialized: 
                ...
                if etype == EntityType.CORE:
                    ...
                    if SPAWN_TURN == 0:
                        ...
                        # Only switch to attack in late game when resources are low
                        # This keeps economy builders alive longer to expand
                        go_attack = (
                            (round_num > 1500 and titanium < 400 and c.get_id() % 2 == 0) or
                            (round_num > 1200 and titanium < 200 and c.get_id() % 2 == 0)
                        )
                        if go_attack:
                            if (self.me == builder):
                                self.initialized = False
