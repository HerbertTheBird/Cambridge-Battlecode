...
def generate_explore_target():
    ...
    unclaimed = frontier & ~bots.z_deprecated.v869.units.builder.claimed_targets[comm_flag]
...
def run():
    ...
    log("EXPLORE")
    if bots.z_deprecated.v869.units.builder._initial_explore_target is not None:
        if map_info._my_pos.distance_squared(bots.z_deprecated.v869.units.builder._initial_explore_target) <= 18:
            bots.z_deprecated.v869.units.builder._initial_explore_target = None
        else:
            explore_target = bots.z_deprecated.v869.units.builder._initial_explore_target
