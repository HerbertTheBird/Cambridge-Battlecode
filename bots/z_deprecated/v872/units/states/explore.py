...
import bots.z_deprecated.v872.units.builder
from cambc import *
import random
from bots.z_deprecated.v872.log import log
...
def init(c: Controller):
    global rc, nav
    rc = c
    nav = bots.z_deprecated.v872.units.builder.nav
...
def generate_explore_target():
    ...
    unclaimed = frontier & ~bots.z_deprecated.v872.units.builder.claimed_targets[comm_flag]
...
def run():
    ...
    log("EXPLORE")
    if bots.z_deprecated.v872.units.builder._initial_explore_target is not None:
        if map_info._my_pos.distance_squared(bots.z_deprecated.v872.units.builder._initial_explore_target) <= 18:
            bots.z_deprecated.v872.units.builder._initial_explore_target = None
        else:
            explore_target = bots.z_deprecated.v872.units.builder._initial_explore_target
