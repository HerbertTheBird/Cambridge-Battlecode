...
from bots.z_deprecated.v872.log import DRAW_DEBUG, log
...
def score():
    ...
    if preferred:
        return 9
    if fallback:
        if bots.z_deprecated.v872.units.builder._harvest_zone & (1<<(rc.get_position().x + rc.get_position().y*map_info._width)):
            return 6
        else:
            return 8
    return 0
