...
def generate_explore_target():
    ...
    seeds = 0
    claims = 0
    for i, f in enumerate(bots.z_deprecated.Lethe_baseline.units.builder.claimed_targets):
    ...
    unclaimed = prev_frontier & ~bots.z_deprecated.Lethe_baseline.units.builder.claimed_targets[comm_flag]
