...
from bots.z_deprecated.Lethe_baseline.pathing import Pathing
import bots.z_deprecated.Lethe_baseline.comms as comms
from cambc import *
import bots.z_deprecated.Lethe_baseline.units.builder
...
def _my_claims():
    ...
    return available & ~pathing.voronoi_claim(bots.z_deprecated.Lethe_baseline.units.builder.claimed_senders[comm_flag], my_mask, available)
...
def harvestable_ore():
    ...
    return (ore
            ...
            & bots.z_deprecated.Lethe_baseline.units.builder._harvest_zone
            & ~cant_harvest)
