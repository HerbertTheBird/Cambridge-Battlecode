...
Pantheon, consisting of \href{https://www.linkedin.com/in/derek-wang-a3b815408/}{Derek Wang}, \href{https://www.linkedin.com/in/yufan-skye-wang/}{Yufan Wang}, \href{https://www.linkedin.com/in/alext101/}{Alex
  Thummalapalli}, and \href{https://www.linkedin.com/in/ioannis-pantidis/}{Ioannis Pantidis}.
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.31\linewidth}
    \centering
    \phantom{\includegraphics[width=\linewidth]{images/bfs_5.png}}
  \end{subfigure}
...
Many of our derived bitmasks, calculated targets, etc., are memoized on the map info structures they depend on. We also memoize some calculations irrespective of local map changes.
...
Our tournament results are summarized in Table~\ref{tab:results}. Sprints were the weekly tournaments held throughout the competition, where teams could evaluate their performance and gain a better understanding of the meta. The International Qualifiers was a tournament for the top eight teams outside the UK, offering a chance to advance to the Grand Finals.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lll}
    ...
    \textbf{Grand Finals}     & \textbf{5/4} & \textbf{1st}                                 \\
    \textit{Meme Tournament*} & 5/9          & Top 8                                        \\
    \textit{Pong Tournament*} & 5/9          & 2nd                                          \\
    \midrule
    \multicolumn{3}{l}{\footnotesize *For-fun tournaments played with different rule-sets.} \\
    \bottomrule
  \end{tabular}
\end{table}

Figure~\ref{fig:elo-results} shows our Elo progression over time. We went into the Grand Finals as the first seed (Figure~\ref{fig:ladder-results} shows the top eight seeded teams before the Grand Finals).

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{images/results.png}
  \caption{Elo rating over the course of the competition.}
  \Description{A graph showing Team Pantheon's Elo rating over time throughout the competition.}
  \label{fig:elo-results}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{images/ladder.png}
  \caption{Top eight seeded teams for the Grand Finals.}
  \Description{A leaderboard image showing the top eight seeded teams before the Grand Finals.}
  \label{fig:ladder-results}
\end{figure}

\section{Conclusion}

We learned a lot over the course of the competition through trial and error. We had many more bot versions outside of the ones listed at the beginning (such as Hermes and Hephaestus, along with sub-versions of all of our bots) and were still adding in new strategies like attack route just hours before the final submission deadline.
